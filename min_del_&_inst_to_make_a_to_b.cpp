// minimum no of deletion and insertion to make a to b 
...
void lcs2(string s, string s2, int n, int m)
{
    ...
    cout << "Minimum no of deletion : " << n-dp[n][m] << nn;
    cout << "Minimum no of insertion : " << m-dp[n][m] << nn;
}
...
Minimum no of deletion : 8
Minimum no of insertion : 0 
*/